...
const footerLink=[English (IN) English (UK) English (US) Deutsch Español Français (Canada) Français (France) Italiano Polski Portugês (Brasil)]
function Footer() {
  return (
    <footer className="footer">
      ...
      <div className="region w-full  flex-center">
        <p className="p-title">Choose Your Region</p>
        <div></div>
      </div>
    </footer>
  );
