...
import { NCDA } from "../../assets/extraImages";
  ...
  return (
    <footer className="footer">
      ...
      <div className="container mx-auto">
        <Row className=" mx-auto justify-around py-5">
      ...
      <div className="region w-full  flex-center gap-4 py-4">
      ...
      <div className="flex container mx-auto justify-between gap-4 py-4 text-sm">
        <p>© 2025 Works Limited. All Rights Reserved.</p>
        <div>
          <img src="/src/assets/NCDA-ORG-Logo-23-24@1x.png" alt="ncda" />
          <img src="/src/assets/prwcc.png" alt="prwcc" />
        </div>
      </div>
    </footer>
  );
