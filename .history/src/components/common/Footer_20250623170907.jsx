  ...
  return (
    <footer className="footer ">
      ...
      <div className="w-full region">
        <div className="container mx-auto px-4  sm:px-6 lg:px-8 flex flex-col xs:flex-row justify-center xs:justify-between items-center gap-4 py-4">
          <p className="text-sm font-medium !mt-0 p-title text-center xs:text-left">
            Choose Your Region
          </p>

          <div className="flex gap-4 flex-wrap justify-center xs:justify-start items-center max-w-full">
