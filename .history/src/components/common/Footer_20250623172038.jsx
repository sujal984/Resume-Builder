        ...
        <Row className=" justify-between py-5">
          ...
          <Col xs={{ span: 24 }} lg={{ span: 5 }}>
            <div className="flex flex-col h-full justify-between">
              {/* Top part of Zety section */}
              <div>
                <h1 className="heading inline-block">Zety</h1>
                {/* Use max-w-full to ensure it doesn't overflow its parent Col */}
                {/* Use max-w-xs to give it a sensible max width on small screens if needed */}
                <p className="my-4 break-words max-w-full sm:max-w-xs">
                  Zety's resume templates and job-winning resume builder and
                  cover letter generator are powered by the best career experts
                  and data-driven career insights.
                </p>
                ...
                <Button
                  type="primary"
                  size="large"
                  className="rounded-full font-semibold text-blue-600 bg-blue-50 hover:bg-blue-100 w-full sm:w-auto" // Add w-full for small screens
                  style={{
                    padding: "15px 25px 13px",
                  }}
                >
              ...
              <div className="mt-8 lg:mt-0"> {/* Add margin top for spacing when stacked */}
                <div className="flex gap-4 my-4 connection">
                  <TwitterIcon /> <LinkedinIcon /> <FacebookIcon />
                </div>
                <div>
