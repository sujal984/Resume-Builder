...
function Footer() {
  return (
    <footer className="footer ">
      ...
      <div className="container mx-auto ">
        {/* <Row className=" justify-between py-5">
          <Col xs={{ span: 24 }} lg={{ span: 5 }}>
            <div className="flex gap-10 flex-col     justify-self-center">
              <div>
        ...
        <Row justify="space-between" className="py-5" gutter={[16, 24]}>
          <Col xs={{ span: 24 }} lg={{ span: 5 }}>
            <div className="flex flex-col gap-10  justify-self-center text-center">
              <div>
                <h1 className="heading inline-block !text-white">Zety</h1>
                <p className="my-4 w-[250px] break-words">
                  Zety's resume templates and job-winning resume builder and
                  cover letter generator are powered by the best career experts
                  and data-driven career insights.
      ...
      <div className="flex container mx-auto justify-between gap-4 py-4 text-sm   md:flex-row flex-col ">
