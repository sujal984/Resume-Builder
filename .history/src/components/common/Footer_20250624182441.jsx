    ...
    <footer className="footer ">
      ...
      <div className="container mx-auto ">
        ...
        <Row justify="space-between" className="py-5" gutter={[16, 16]}>
          <Col xs={{ span: 5 }}>
            <div className="flex flex-col gap-10 ">
              <div>
                <h1 className="heading  !text-white !w-full">Zety</h1>
        ...
        <Row justify="space-between" className="py-5" gutter={[16, 16]}>
          <Col xs={24} md={5}>
            <div className="flex flex-col gap-10">
              <div>
                ...
                <p className="my-4 md:w-[250px] xs:w-full">
                  Zety's resume templates and job-winning resume builder and
          ...
          {[resume, cv, coverLetter, support].map((section, i) => (
            <Col key={i} xs={12} sm={6} md={3}>
              <p className="p-title">
                {["RESUME", "CV", "COVER LETTER", "SUPPORT"][i]}
              </p>
              <ul>
