    ...
    <>
      ...
      <Content>
        <section className="container ">
          <Row className="w-fit  flex  justify-center">
            <Col span={12} className="my-15">
              <h1 className="text-5xl font-bold-500">
                {" "}
                Best Online Resume Builder <br />
                (Free to Try)
              </h1>
            </Col>
            <Col span={12}>
              <div
                className="px-4 image-part"
                style={{
                  backgroundImage: url("/src/assets/backgorundbeforetriangles"),
