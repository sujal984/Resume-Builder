...
export default function CustomHeader() {
  ...
  return (
    <>
      <Header className="  p-0 xl:mx-44 px-4  flex items-center justify-between bg-white  xs:mx-0">
          ...
          <Row className="">
            <Col xs={{ span: 24 }} lg={{ span: 12 }} className="">
              <div
                ...
                className=" px-4 xs:w-full xl:w-fit  justify-center align-middle "
              >
                <h1
                  style={{
                    fontSize: "44px",
            ...
            <Col span={12}>
              <div className="px-4 image-partxs:!w-full ">
                <img
