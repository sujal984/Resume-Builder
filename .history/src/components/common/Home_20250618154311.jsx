...
export default function CustomHeader() {
  ...
  return (
    <>
      <Header className=" h-24 p-0 px-4 container  flex items-center justify-between bg-white">
        <div className="flex items-center justify-center !w-full mx-40 ">
          <div className="flex items-center justify-self-center   xs:mx-0   xl:mx-44 space-x-2">
      ...
      <Content className="container w-full flex justify-self-center ">
        <section className="">
          <Row>
