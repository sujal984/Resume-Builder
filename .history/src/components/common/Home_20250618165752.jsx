  ...
  return (
    <>
      ...
      <Header className="container-fluid p-0  grid">
        <div className="flex items-center justify-between  px-4 xl:mx-40  small-screen ">
          <h1 className="text-2xl font-bold text-gray-800 break-words ">
            zety
          </h1>

          <div className="right-header flex justify-between gap-2 xs:hidden md:flex">
          ...
          <div className="right-header xs:flex md:hidden">
            <Button
              size="large"
              onClick={showDrawer}
        ...
        <section className="container-fluid  ">
          ...
          >
            <Col
              ...
              md={{ span: 8 }}
              xl={{ span: 12 }}
              className="px-4 content-center justify-center"
            >
              <div className="  ">
                <h1
                  style={{
