  ...
  return (
    <>
      ...
      <Header className="container-fluid p-0  grid">
        <div className="flex items-center justify-between  px-4 lg:mx-40 ">
          <h1 className="text-2xl font-bold text-gray-800 break-words ">
            zety
          </h1>

          <div className="right-header flex justify-between gap-2 xs:hidden lg:flex">
          ...
          <div className="right-header xs:flex lg:hidden">
            <Button
              size="large"
              onClick={showDrawer}
