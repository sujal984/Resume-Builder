...
const description = [
  {
    ...
    desc: "Zety’s resume builder will save you time and provide expert tips every step of the way. Creating a resume has never been easier.",
  },
  {
    title: "Cover Letter Builder",
    desc: "Smoothly generate a job-winning cover letter with our drag-and-drop interface.",
  },
  {
    title: "ATS-Friendly Resume Templates",
    desc: "Grab recruiters’ attention with one of 18 professional resume templates designed by career experts.",
  },
  {
    title: "Free Career Advice Resources",
    desc: "Consciously shape your career with helpful guides and resume examples. Writing the perfect job application? Asking for a raise? Learn it all (and more) on our blog.",
  },
  {
    title: "Resume Check",
    desc: "Score and check your resume in real-time with our resume checker. Get actionable tips to improve your resume.",
  },
  {
    title: "Ready-Made Content Suggestions",
    desc: "Discover expert-crafted content suggestions and create a professional job application in minutes.",
  },
];
