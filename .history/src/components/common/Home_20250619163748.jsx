        ...
        <section className="container mt-10 text-center">
          ...
          <Row gutter={[24, 24]} justify="center">
            {Resumetype.map((item, index) => (
              ...
              >
                <div className="resume-card border rounded-2xl shadow-md p-6 w-full max-w-xs flex flex-col items-center bg-white transition-all">
                  <img
                    src={item.img}
                    alt={item.title}
                  ...
                  />
                  <Button
                    className="resume-btn  content-btn mb-3 opacity-0 hover:opacity-100"
                    type="primary"
                  >
                    {item.btntext}
                  </Button>
