    ...
    <>
      ...
      <Content>
        ...
        <section className="container mt-6 justify-self-center justify-center flex flex-col items-center">
          ...
          <Row gutter={[16, 16]} className="!border" style={{ rowGap: "16px" }}>
        ...
        <section className="container mt-10 text-center justify-self-center">
          ...
          <Row gutter={[24, 24]} justify="center">
            {Resumetype.map((item, index) => (
              ...
              >
                <div className="justify-self-center resume-card border rounded-2xl shadow-md p-6 w-full max-w-xs flex flex-col items-center bg-white transition-all">
                  <img
                    src={item.img}
                    alt={item.title}
