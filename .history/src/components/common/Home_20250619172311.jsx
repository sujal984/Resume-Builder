  ...
  return (
    <>
      ...
      <Content>
        ...
        <section className="sm:container mt-10 text-center justify-self-center">
        ...
        <section className="w-full px-4 sm:px-6 lg:px-8 mt-10 text-center">
          <p className="section-subtitle flex justify-center items-center gap-2 text-base md:text-lg font-medium text-gray-700 mb-6">
            <CheckCircleFilled className="text-green-600" />
            Our resume examples helped people land jobs at Microsoft, Google,
            and other top companies.
          ...
          <Row gutter={[16, 16]} justify="center">
            {Resumetype.map((item, index) => (
              <Col key={index} xs={24} sm={12} md={8} lg={6} className="p-2">
                <div className="resume-card border rounded-2xl shadow-md p-6 w-full flex flex-col items-center bg-white transition-all">
                  <img
                    src={item.img}
                    alt={item.title}
                    className="mb-4 w-32 h-32 object-contain"
                  />
                  <Button className="resume-btn mb-3" type="primary">
                    {item.btntext}
                  </Button>
                  <p className="text-center text-base font-medium">
                    {item.title}
