  ...
  return (
    <>
      ...
      <Content>
        ...
        <section className="conatiner bg-[#2488e3] mt-6 justify-self-center justify-center  items-start align-middle">
          <div className="">
            <h2 className="section-title  !text-4xl text-center !text-white px-12 pt-20">
              Try Our Easy-To-Use Resume Builder
            </h2>
            <p className="fst-para text-center break-words text-white  ">
            ...
            <Button className="content-btn mb-20" type="primary">
