  ...
  return (
    <>
      ...
      <Content>
        ...
        <section className="md:container mt-6    md:justify-self-center">
          <div>
            {" "}
        ...
        <section className="sm:container  sm:items-self-center mt-6 justify-self-center justify-center flex flex-col items-center">
        ...
        <section className="sm:container mt-6 text-center justify-self-center">
          ...
          <Row gutter={[24, 24]} justify="center">
            {Resumetype.map((item, index) => (
              ...
              >
                <div className="justify-self-center resume-card border rounded-2xl shadow-md p-6 w-full flex flex-col items-center bg-white transition-all ">
                  <img
                    src={item.img}
                    alt={item.title}
        ...
        <section className="container bg-[#2488e3] mt-6 flex flex-col items-start px-4 sm:px-10 md:px-20">
          <div className="w-full sm:ml-10 md:ml-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl text-white text-left pt-10 sm:pt-16 md:pt-20">
              Try Our Easy-To-Use Resume Builder
            </h2>

            <div className="mt-4 max-w-full sm:max-w-[600px] md:max-w-[700px]">
            ...
            <div className="mt-6">
              <Button className="mb-10 w-full sm:w-auto" type="primary">
        ...
        {/* <section className="conatiner bg-[#2488e3] mt-6 flex justify-start flex-col align-middle px-20">
          <div className="ml-20 last-section">
            <h2 className=" !text-5xl !text-start   !text-white  pt-20">
              Try Our Easy-To-Use Resume Builder
            </h2>
            <div className="flex justify-start  md:w-[700px]">
              <p className="fst-para  text-white  ">
                Experience our intuitive resume builder and take a shortcut to
                your dream career. Discover why thousands of job seekers and HR
                experts trust us. Create your best resume quickly and easily
                today.
            ...
            <div className="flex justify-start">
              <Button
                className="content-btn mb-20    xs:w-[100px]"
                type="primary"
              >
                Build Your Resume Now
              </Button>
