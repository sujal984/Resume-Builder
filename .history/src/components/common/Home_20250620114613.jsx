        ...
        <section className="sm:container  sm:items-self-center mt-6  flex-center flex-col ">
          ...
          <Row gutter={[16, 16]} style={{ rowGap: "16px" }}>
            {description.map((item) => (
              <Col md={{ span: 6 }} xs={{ span: 12 }} key={item.key}>
                <Descriptions
                  bordered
                  layout="vertical"
                  column={1}
                  className="inline-block max-w-[300px] max-h-[300px] xs:w-[200px]"
                  items={[
                    {
                      key: item.key,
                      label: item.label,
        ...
        <section className="sm:container mt-12 text-center justify-self-center">
          ...
          <Row gutter={[24, 24]} justify="center">
            {Resumetype.map((item, index) => (
              <Col key={index} xs={12} md={8} lg={6} className="flex-center">
                <div className=" resume-card border rounded-2xl shadow-md p-6 w-full flex-center flex-col  transition-all ">
                  <img
                    src={item.img}
                    alt={item.title}
