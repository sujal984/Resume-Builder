  ...
  return (
    <>
      ...
      <Content>
        ...
        {/* Brand section start */}
        <section className="brand-section flex items-center justify-center mt-12 px-4">
          <div className="text-center">
            <p className="text-lg font-medium text-gray-800 mb-6 break-words">
