  ...
  return (
    <>
      ...
      <Content>
        ...
        <section className="brand-section mt-12 px-4">
          <div className="container mx-auto flex flex-wrap justify-between items-center gap-6 py-6 px-4">
            <p className="text-gray-700 text-base font-medium min-w-[200px]">
              Our customers have been hired by: *
            </p>

            <div className="flex flex-wrap justify-center  flex-rowitems-center gap-6">
              <MicrosoftIcon className="w-[90px] h-auto" />
              <AmazonIcon className="w-[90px] h-auto" />
              <AttIcon className="w-[90px] h-auto" />
              <WalmartIcon className="w-[90px] h-auto" />
              <FedexIcon className="w-[90px] h-auto" />
              <OrangeIcon className="w-[90px] h-auto" />
            </div>
          </div>
        </section>

        {/* <section className=" container-fluid brand-section mt-12 px-4">
          <div className="text-center flex justify-around w-full gap-4">
            <p className="break-words w-[250px]">
              Our customers have been hired by:
            </p>

            <MicrosoftIcon className="brand-image" />
            <AmazonIcon className="brand-image" />
            <AttIcon className="brand-image" />
            <WalmartIcon className="brand-image" />
            <FedexIcon className="brand-image" />
            <OrangeIcon className="brand-image" />
          </div>
        </section> */}
        {/* Brand section end */}
