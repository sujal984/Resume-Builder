    ...
    <>
      ...
      <Content>
        ...
        <section className="brand-section mt-12 px-4 ">
          <div className="container mx-auto lg:flex lg:flex-row sm:justify-evenly xs:flex-col xs:items-center xs:justify-self-center">
            <p>Our customers have been hired by: *</p>
            <div className="grid   grid-row xs:grid-cols-2 sm:grid-cols-3   lg:grid-cols-6 gap-10 ">
              <MicrosoftIcon />
              <AmazonIcon />
              <AttIcon />
              <WalmartIcon />
