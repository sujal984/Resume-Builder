    ...
    <>
      ...
      <Content>
        ...
        <section className="brand-section mt-12 px-4 ">
          <div className="container mx-auto lg:flex  sm:justify-evenly xs:justify-between align-items-center">
            <p>Our customers have been hired by: *</p>
            <div className="grid   grid-row grid-cols-2 sm:grid-cols-3   lg:grid-cols-6 gap-10  ">
              <MicrosoftIcon />
              <AmazonIcon />
              <AttIcon />
              <WalmartIcon />
