    ...
    <>
      ...
      <Content>
        ...
        <section className="brand-section mt-12 px-4 ">
          <div className="container mx-auto lg:flex  sm:justify-evenly xs:justify-self-center ">
            <p>Our customers have been hired by: *</p>
            <div className="grid    xs:grid-cols-1 sm:grid-cols-3   lg:grid-cols-6 gap-10  ">
              <MicrosoftIcon />
              <AmazonIcon />
              <AttIcon />
              <WalmartIcon />
