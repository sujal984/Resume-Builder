      ...
      <Content>
        ...
        <section className="brand-section mt-12 px-4">
          <div className="container mx-auto">
            ...
            <div className="flex flex-wrap justify-center sm:justify-evenly gap-6 sm:gap-10">
              <MicrosoftIcon className="w-24 h-auto" />
              <AmazonIcon className="w-24 h-auto" />
              <AttIcon className="w-24 h-auto" />
              <WalmartIcon className="w-24 h-auto" />
              <FedexIcon className="w-24 h-auto" />
              <OrangeIcon className="w-24 h-auto" />
            </div>
          </div>
        </section>
