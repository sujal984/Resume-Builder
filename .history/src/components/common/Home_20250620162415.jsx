  ...
  return (
    <>
      ...
      <Content>
        ...
        <section className="brand-section mt-12 px-4  align-middle">
          <div className="container mx-auto lg:flex  sm:justify-evenly  ">
            <p>Our customers have been hired by: *</p>
            <div className=" grid    xs:grid-cols-1 sm:grid-cols-3   lg:grid-cols-6 gap-10 xs:ml-[-20px]  ">
        ...
        <section className="brand-section mt-12 px-4">
          <div className="container mx-auto flex flex-col items-center lg:items-start lg:flex-row lg:justify-between lg:flex-wrap gap-4">
            <p className="text-center lg:text-left mb-4 lg:mb-0">
              Our customers have been hired by: *
            </p>
            <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8 md:gap-10 w-full lg:w-auto">
              <MicrosoftIcon className="flex-shrink-0" />
              <AmazonIcon className="flex-shrink-0" />
              <AttIcon className="flex-shrink-0" />
              <WalmartIcon className="flex-shrink-0" />
              <FedexIcon className="flex-shrink-0" />
              <OrangeIcon className="flex-shrink-0" />
            </div>
          </div>
        </section>
