...
export default function CustomHeader() {
  ...
  return (
    <>
      {/* {Header part start} */}
      <Header className="container-fluid p-0  grid fixed top-0 left-0 right-0 z-50 bg-slate-50">
      ...
      <Content>
        ...
        <section className="container-fluid mt-12 ">
          ...
          >
            ...
            <Col
              ...
              className="px-4"
            >
              <div className="lg:px-4  image-part xs:!w-full align-middle">
                <img
                  src="/src/assets/resume-builder-template@1x.png"
                  alt="/src/assets/imagepicture"
                  className="relative xs:justify-self-center fst-page-img z-10 align-middle"
                />
              </div>
            </Col>
          </Row>
        ...
        <section className="brand-section mt-12 px-4 align-middle">
          <div className="container mx-auto flex flex-col lg:flex-row lg:justify-evenly items-center">
        ...
        {/* <section className="brand-section mt-12 px-4 align-middle">
          <div className="container mx-auto flex flex-col lg:flex-row lg:justify-evenly items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-6 gap-10 justify-items-center">
              <MicrosoftIcon />
              <AmazonIcon />
              <AttIcon />
              <WalmartIcon />
          ...
          <div className="h-full">
            ...
            <Row gutter={[16, 16]} style={{ rowGap: "16px" }}>
              {description.map((item) => (
                ...
                >
                  <div className="h-full w-auto border-l p-2 border-[#eff2fa]">
                    <h4 className="mb-2">{item.label}</h4>
                    <p>{item.children}</p>
                  </div>
                </Col>
              ))}
