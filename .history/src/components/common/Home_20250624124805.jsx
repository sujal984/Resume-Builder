  ...
  return (
    <>
      ...
      <Content>
        ...
        <section className="conatiner bg-[#2488e3] mt-24 flex justify-start flex-col align-middle px-20">
          <div className="md:ml-20 last-section flex  flex-col align-middle justify-between">
            ...
            <Button className="content-btn  last-btn  " type="primary">
