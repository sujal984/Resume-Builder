    ...
    <>
      ...
      <Content>
        ...
        <section className="md:container mt-24 md:justify-self-center px-4">
          ...
          <div className="container mx-auto py-4  gap-2 flex justify-center xs:hidden lg:flex">
            {Array.from({ length: 3 }).map((_, idx) => (
              <div key={idx}>
                <img
              ...
              >
                <div className="flex-shrink-0">
                  <img
                    src={step.img}
                    alt={`Step ${step.number}`}
                    className="md:w-[150px] md:h-[150px] xs:w-[100px] xs:h-[100px] mx-auto mb-4"
                    style={step.number === 1 ? { height: "170px" } : {}}
                  />
                </div>
                {/* <div> */}
