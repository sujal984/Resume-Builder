  ...
  return (
    <>
      ...
      <Header className="container-fluid p-0  grid ">
        <div className="flex items-center justify-between   py-4 px-4 xl:mx-40 ">
          ...
          <div className="right-header xs:flex xl:hidden">
            <Button
              size="large"
              onClick={showDrawer}
              className="text-2xl !text-gray-800 !border-gray-600 z-10  "
            >
              <MenuOutlined />
            </Button>
            <Drawer
      ...
      <Content>
            ...
            <Row className="flex-center ">
              ...
              >
                <div className="  ">
                  ...
                  <p className="fst-para xs:w-[200px] z-[100]">
                    Writing a resume is a daunting task. Nothing but stress,
                    confusion, and wasting precious hours on making an
                    attractive template. But not with Zety. Let us take over.
                  </p>
                  <Button
                    size="large"
              ...
              <Col
                ...
                className="px-4 "
              >
                <div className="lg:px-4  image-part xs:!w-full xs:mt-10 ">
                  <img
        ...
        {/* <section className="md:container mt-24    md:justify-self-center">
          ...
          <div className="flex gap-6 px-10   pt-4 xs:hidden lg:flex">
        ...
        <section className="md:container mt-24 md:justify-self-center px-4">
          <div className="text-center mb-12">
            <h2 className="md:text-4xl sm:text-3xl font-[500] text-gray-700  xs:text-2xl">
              Just Four Simple Steps to Download Your Resume
            </h2>
          </div>
          <div className="container mx-auto py-4  gap-6 flex justify-center xs:hidden lg:flex">
            {Array.from({ length: 3 }).map((_, idx) => (
              <div key={idx}>
                <img
          ...
          <div className="flex flex-col xs:justify-self-center lg:flex-row justify-center items-start lg:items-center gap-8">
            {steps.map((step, idx) => (
              <div
                key={step.number}
              ...
              >
                <div className="flex-shrink-0">
                  <img
                    src={step.img}
                    alt={`Step ${step.number}`}
                    className="md:w-[150px] md:h-[170px] xs:w-[100px] xs:h-[100px] mx-auto mb-4"
                    style={step.number === 1 ? { height: "190px" } : {}}
                  />
                </div>
                {/* <div> */}
                <div className="h-10 w-10 rounded-full bg-blue-400 text-white flex items-center justify-center text-xl font-semibold mb-4">
                  {step.number}
                </div>
                <p className="text-gray-700 max-w-xs w-[150px]">
                  {step.description}
                </p>
              </div>
              // </div>
          ...
          <div className="h-full">
            <Row gutter={[16, 16]} style={{ rowGap: "16px" }}>
              {description.map((item) => (
                ...
                >
                  <div className="h-full w-[300px] border-l pl-2 mt-2 border-[#eff2fa]">
        ...
        <div className="container mx-auto">
          <Tabs defaultActiveKey="1" centered className="mt-24 ">
            <TabPane tab="Professional Resumes" key="1">
              <section className="sm:container mt-6   text-center justify-self-center">
                <p className="section-subtitle flex-center  gap-2 mb-6 bg-[#f4f9fd]">
                  <CheckCircleFilled className="text-green-600" />
                  Our resume examples helped people land jobs at Microsoft,
            ...
            <TabPane tab="Creative Resumes" key="2">
              <section className="sm:container mt-6   text-center justify-self-center">
                <p className="section-subtitle flex-center  gap-2 mb-6 bg-[#f4f9fd]">
                  <CheckCircleFilled className="text-green-600" />
                  Our Creative resume examples helped people land jobs at
                  Microsoft, Google, and other top companies.
                </p>
            ...
            <TabPane tab="Modern Resumes" key="3">
              <section className="sm:container mt-6   text-center justify-self-center">
                <p className="section-subtitle flex-center  gap-2 mb-6 bg-[#f4f9fd]">
                  <CheckCircleFilled className="text-green-600" />
                  Our Modern resume examples helped people land jobs at
                  Microsoft, Google, and other top companies.
                </p>
        ...
        <section className="conatiner bg-[#1f85e1] mt-24 flex justify-start flex-col align-middle px-20 py-20 text-white">
          <div className="md:ml-20 last-section sm:w-[500px]">
            <h2 className="heading-lst pt-20 ">
              Try Our Easy-To-Use Resume Builder
            </h2>
            <div className="flex justify-start  md:w-[500px]">
              <p className="last-sec-para !text-[16px] !font-[400px] text-white ">
            ...
            <Button
              className="bg-white text-[#071431]  last-btn mb-20 mt-5 px-8 py-9 rounded-full font-semibold"
              type="primary"
            >
