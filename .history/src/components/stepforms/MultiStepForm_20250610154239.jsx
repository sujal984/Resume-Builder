...
const MultiStepForm = ({
  ...
  return (
    <>
      <div
        className="multi-step-form bg-white rounded-xl shadow-lg p-4"
        style={{
          width: "100%",
          height: "auto",
          minHeight: stepNo === 5 ? "65rem" : "30rem",
        }}
      >
        <Form.Provider>
          <StepForms stepNo={stepNo}>
            {stepNo == 0 && (
              <>
                ...
                >
                  <h1 className="text-xl font-bold border-b mb-4">
                    Basic Form
                  </h1>
                  <Row gutter={[16, 16]}>
                    <Col xs={24} sm={12}>
            ...
            {stepNo === 1 && (
              <>
                ...
                <Form
                  name="education"
                  form={educationForm}
                  className="education-form w-full"
                  layout="vertical"
                  initialValues={formData}
                  onValuesChange={(_, all) =>
                ...
                >
                  <Row className="w-full">
                    <Form.List name="education" className="edu-list w-full">
                      {(fields, { add, remove }) => (
                        <>
                          {fields.map(({ key, name, ...restField }) => (
                            <div
                              key={key}
                              className="mb-4 border p-4 rounded-lg w-full"
                            >
