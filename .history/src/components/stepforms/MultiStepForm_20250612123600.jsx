...
const MultiStepForm = ({
  ...
  return (
    <>
      <div
        className="multi-step-form bg-whiterounded-xl shadow-lg p-3"
        style={{
          width: stepNo === 5 ? "94rem" : "68rem",
          height: stepNo === 5 ? "65rem" : "38rem",
        }}
      >
        <Form.Provider>
            ...
            {stepNo == 0 && (
              <>
                ...
                >
                  ...
                  <Row style={{ height: "30rem" }} gutter={24}>
                    <Col
                      span={12}
                      className="text-center w-full pb-1"
                      // style={{ height: "100%" }}
                    >
                      <Form.Item
                        name="fname"
                    ...
                    <Col span={12} className="w-full pb-1 mt-1.5">
                      <Form.Item
                        name="lname"
                        label="last Name"
                        className="form-items  "
                    ...
                    <Col span={24} className="text-center pr-4 ">
                      <Form.Item name="objective" label="Career Objective">
                        <Input.TextArea rows={2}   background-color: #eff2f9;/>
                      </Form.Item>
