          ...
          {stepNo == 0 && (
            <>
              <Form
                ...
                onValuesChange={(_, all) => handleValuesChange("basic", _, all)}
              >
                <h1
                    ...
                    {(fields, { add, remove }) => (
                      <>
                        {fields.map(({ key, name, ...restField }) => (
                          <div key={key} className=" border p-1 rounded w-full">
            ...
            <>
              ...
              >
                ...
                <Form.List name="activities">
                  {(fields, { add, remove }) => (
                    <>
                      <label className="ant-form-item-label">Activities</label>
                      {fields.map(({ key, name, ...restField }) => (
                        <Form.Item
                          {...restField}
                          key={key}
