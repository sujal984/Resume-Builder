...
const customFormat = (value) => ` ${value.format(yearFormat)}`;
...
const MultiStepForm = ({
  ...
  const getDayjsValues = () => {
    if (!value || !value.length) return [null, null];
    return [
      value[0] ? dayjs(value[0], yearFormat) : null,
      value[1] ? dayjs(value[1], yearFormat) : null,
    ];
  };
  const next = async () => {
    let currentForm;
                                ...
                                <Col span={8}>
                                  ...
                                  >
                                    <RangePicker
                                      ...
                                      // defaultValue={[
                                      //   dayjs("2015", yearFormat),
                                      //   dayjs("2016", yearFormat),
                                      // ]}
                                      format={customFormat}
                                    />
                                  </Form.Item>
              ...
              <>
                ...
                <Form
                  ...
                  onValuesChange={(_, all) => {
                    ...
                    handleValuesChange("skills", _, all);
                  }}
                >
