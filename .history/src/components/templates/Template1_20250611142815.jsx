  ...
  return (
    <>
      ...
      <div
        ...
        id="resume"
        style={{
          marginLeft: newStep ? "-11rem" : "32rem",
      ...
      <div style={{}}>
        <div
          ...
          style={{
            ...
            marginTop: stepNo === 5 ? "60rem" : "36rem",
          }}
          // className="footer w-full"
          // style={{
          //   position: "relative",
          //   marginTop: stepNo === 5 ? "2rem" : "2rem",
          // }}
        >
          <div
            className="pb-5 "
          ...
          >
            ...
            {stepNo === 4 ? (
              ...
              <Button
                onClick={next}
                type="primary"
                className="py-3  mx-1.5 mr-2  px-8 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-medium shadow-md hover:shadow-lg transition-all"
              >
