      ...
      <div style={{}}>
        <div
          ...
          style={{
            ...
            marginTop: stepNo === 5 ? "60rem" : "37rem",
          }}
          ...
          >
            ...
            {stepNo === 4 ? (
              ...
              <Button
                onClick={next}
                type="primary"
                className="py-3  mx-1.5 mr-4  px-8 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-medium shadow-md hover:shadow-lg transition-all"
              >
