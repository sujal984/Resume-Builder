  ...
  return (
    <>
      <div
        ...
        style={{
          width: "650px", // Decrease width (adjust as needed)
          minHeight: "1100px", // Increase height (adjust as needed)
          margin: "40px auto",
          background: "#fff",
          borderRadius: "12px",
        ...
        <Row style={{ height: "auto " }}>
          ...
          <Col span={24}>
            <div style={{ marginTop: "auto" }}>
              <h3 className="section-title" style={{ paddingLeft: "31rem" }}>
                Contact
              </h3>
              <div className="contact-section" style={{ paddingLeft: "31rem" }}>
