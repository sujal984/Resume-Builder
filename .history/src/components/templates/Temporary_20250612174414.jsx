    ...
    <>
      ...
      >
        <Row style={{ height: "auto " }}>
          ...
          {/* Right Content Area */}
          <Col span={24}>
            <div className="header-dark header" style={{ height: "11rem" }}>
              <div className="name " style={{ marginLeft: "20rem" }}>
                {" "}
                Olivia Wilson
              </div>
          ...
          <Col span={24}>
            <div style={{ marginTop: "auto", height: "11rem" }}>
              <h3 className="section-title" style={{ paddingLeft: "21rem" }}>
                Contact
              </h3>
              <div className="contact-section" style={{ paddingLeft: "21rem" }}>
