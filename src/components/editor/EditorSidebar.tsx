...
import { User, FileText, Briefcase, GraduationCap, Wrench, LayoutGrid, Palette, Plus } from "lucide-react";
                            ...
                            {sections.map(section => (
                                <div
                                    ...
                                    className={cn(
                                        ...
                                        section.isVisible ? "bg-white" : "bg-gray-50 opacity-60"
                                    )}
                                >
                                    <div className="flex items-center gap-2 flex-1">
                                        <div className={cn(
                                            "p-1.5 rounded-md",
                                            section.isVisible ? "bg-violet-100 text-violet-600" : "bg-gray-200 text-gray-500"
                                        )}>
